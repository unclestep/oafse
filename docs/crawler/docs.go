// Package crawler Code generated by swaggo/swag. DO NOT EDIT
package crawler
            ...
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "description": "Site URL to start crawling from",
                        "name": "url",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "boolean",
                        "example": false,
                        "description": "Wipe the entire crawl cache before seeding",
                        "name": "reindex",
                        "in": "query"
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/json.CrawlResponse"
                        }
                    },
                    "400": {
